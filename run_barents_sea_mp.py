...
def get_particle_set(fieldset, run3D=False):
    ...
    lonCorners = [45.37941658, 45.63887346, 45.67183721, 45.41217935]
    ...
    lons = np.array(lon_t.flatten())
    lats = np.array(lat_t.flatten())
...
def run_barents_sea_mp(outfile, run3D=False):
